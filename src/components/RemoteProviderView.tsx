...
interface RemoteProviderViewProps {
  provider: {
    name: string;
    rating: number;
    totalRatings: number;
  ...
  return (
    <div className="p-8">
      ...
      <div className="space-y-6">
        ...
        {status === 'in_progress' && isVideoConnected && (
...
export default RemoteProviderView;